...
$string['camera_comingsoon'] = 'La captura amb càmera en directe s\'activarà en un proper lliurament. De moment, pugeu una fotografia de prova per validar el desament al perfil de Moodle.';
$string['manual_capture_label'] = 'Fotografia de prova (mode manual, lliurament 1)';
