...
$string['export_filetype_activity_desc'] = 'PDF (vertical u horizontal) o Excel, con columnas para marcar a mano o digitalmente (asistencia, autorización, transporte…). Para salidas y talleres.';
$string['export_format'] = 'Formato de salida';
...
$string['error_phpspreadsheetmissing'] = 'Este Moodle no tiene disponible la librería PhpSpreadsheet (necesaria para exportar a Excel). Contacta con el administrador del servidor, o genera el documento en PDF mientras se resuelve.';
...
$string['activity_columns_warning'] = 'Esta combinación de columnas no cabría de forma legible. Quita alguna, o pon «Observaciones» en modo corto.';
...
$string['activity_col_email'] = 'Correo';
$string['activity_col_observacions'] = 'Observaciones';
$string['activity_obs_width'] = 'Ancho de Observaciones';
$string['activity_obs_width_normal'] = 'Normal (todo el espacio libre)';
$string['activity_obs_width_short'] = 'Corta (la mitad, deja sitio para más columnas)';
...
$string['activity_generate'] = 'Generar documento';
$string['activity_generating'] = 'Generando el documento…';
$string['activity_nocohort'] = 'Selecciona un grupo o clase para continuar.';
$string['activity_format'] = 'Formato de salida';
$string['activity_format_help'] = 'El Excel no incluye fotografías ni orientación de página; las columnas de casilla o texto se generan como celdas vacías con borde para rellenarlas desde el ordenador.';
$string['activity_format_pdf'] = 'PDF';
$string['activity_format_excel'] = 'Excel (.xlsx)';
$string['activity_orientation'] = 'Orientación de página';
$string['activity_orientation_landscape'] = 'Apaisado (A4)';
